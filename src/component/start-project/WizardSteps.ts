...
import StepProjectSubmit from "./steps/StepProjectSubmit";
        ...
        description:
          "Help us understand what your business does and the services you provide.",
  ...
  description:
    "Everything looks good. Submit your project request and we'll take it from here.",
  component: StepProjectSubmit,
  isValid: () => true,
  autoAdvance: false,
},    
          };
